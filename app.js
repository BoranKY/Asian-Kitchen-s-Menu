...
// BUTONS CREATED
let button1DOM=document.createElement("button")
button1DOM.innerHTML="All"
button1DOM.setAttribute('id','all')
button1DOM.classList.add("btn" ,"btn-light")
buttonDOM.appendChild(button1DOM)

let button2DOM=document.createElement("button")
button2DOM.innerHTML="Korea"
button2DOM.setAttribute('id','korea')
button2DOM.classList.add("btn" ,"btn-light")
buttonDOM.appendChild(button2DOM)

let button3DOM=document.createElement("button")
button3DOM.innerHTML="Japan"
button3DOM.setAttribute('id','japan')
button3DOM.classList.add("btn" ,"btn-light")
buttonDOM.appendChild(button3DOM)

let button4DOM=document.createElement("button")
button4DOM.innerHTML="China"
button4DOM.setAttribute('id','china')
button4DOM.classList.add("btn" ,"btn-light")
buttonDOM.appendChild(button4DOM)

// Gives margin to the buttons
button1DOM.style.margin="5px"
button2DOM.style.margin="5px"
button3DOM.style.margin="5px"
button4DOM.style.margin="5px"
